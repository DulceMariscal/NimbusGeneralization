...
names={'WithinEnvSwitch (-\DeltaEMG_{on(+)})2','Adapt (\DeltaEMG_{on(-)})2','PosShort','ShortSplit','-Shoe\DeltaOn(+)2','-\Deltaoff(+)','-Shoe\Deltaoff(+)','OGPostShoe','OGPostPosShort','-\Deltaoff(-)','-Shoe\Deltaoff(-)','OGPostNegShort','-\Deltaon(-)'};
...
eps=defineEpochs(names,...
                {'TM tied 2','Neg Short','Pos Short','Short split','TM fast','Pos Short','Short split','OG 1','OG 2','Neg Short','Short split','OG 3','TM tied 3'},...
                [-40 20 20 20 -40 -20 -20 20 20 -20 -20 20 -40],...
                [0,1,1,exemptFirstShortSplit,0,0,0,1,1,0,0,1,0],...
                [5,0,0,0,5,5,5,0,0,5,5,0,5],...
                nantype);
