...
names={'Env_{Switch}','TMbase','Adapt (\DeltaEMG_{on(-)})','SplitPos','TR base','NIMBase',...
   'Task_{Switch}','Post1-Adapt_{SS}','Post1_{Early}','Post1_{Late}','Post2_{Early} - Post1_{Late}','Post2_{Late}','NIM Base','NonAdapt (-\DeltaEMG_{on(+)})'};
