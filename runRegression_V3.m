    function [fitTrans1NoConst,fitTrans2NoConst,fitTrans3NoConst]=runRegression_V3(Data, normalizeData, isGroupData, dataId, resDir, saveResAndFigure, version, usefft, regressorNames)
    ...
    if nargin < 9
%         regressorNames = {'Adapt','WithinContextSwitch','MultiContextSwitch','Trans1','Trans2','Trans3'}; %default names
         regressorNames = {'Adapt','WithinContextSwitch','MultiContextSwitch','Trans1','Trans2'};
    end
...
%     
%     disp('Transition 3')
%     beta2=stepwisefit(X,Y3, 'PRemove',0.05)
    ...
    if saveResAndFigure
        ...
        if ~isGroupData
            save([resDir dataId 'models_ver' num2str(usefft) num2str(normalizeData)], 'fitTrans1NoConst','fitTrans2NoConst','beta1_index','beta2_index','relNom','vec_norm');
        else
