...
names={'OGbase','TMbase','\DeltaEMG_{on(-)}','SplitPos','Env_{Switch}','Task_{Switch}',...
   'Adaptation','OGpost-Adapt_{SS}','OGpost_{Early}','OGpost_{Late}','NIMPost_{Early}','NIMPost_{Late}','NIM Base'};
